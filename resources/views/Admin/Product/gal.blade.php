...
<div class="card">
    <div class="card-header">
        <div class="row mb-0">
            ...
            <div class="col-sm-2 text-right">
                <form method="post" action="{{ route('ProductGallery.update', $id) }}" enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                    <div class="row">
                        <div class="col">
    ...
    <div class="card-body">
        ...
        <div class="card-columns">
            @foreach($gal as $pg)
            <div class="card">
                <div class="card-img-top"><img src="{{url('/img/upload/'.$pg->pg_pic)}}" class="card-img-top img-thumbnail"></div>
                <form action="{{ route('ProductGallery.destroy', $pg->id)}}" method="post" onclick="return confirm('Are you sure.')">
                        @csrf
                        @method('DELETE')
